...
public class NgsiParser {
	...
	public static String deviceModelAdapter(String jsonDeviceModel){
	...
	public static Entity deviceModelAdapter(DeviceModel deviceModel){
	...
	public static String deviceAdapter(String jsonDevice) {
	...
	public static Entity deviceAdapter(DeviceFiw deviceFiw) {
